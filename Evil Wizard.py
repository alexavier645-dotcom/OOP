...
class Paladin(Character):
    ...
    def set_divine_sheild(self):
        self.divine_sheild = True    

    def evade(self, opponent):
        if self.divine_sheild == True:
            self.health == self.health
            print(f"{self.name} health is unchanged by {opponent}'s attack due to Divine Sheild.")
